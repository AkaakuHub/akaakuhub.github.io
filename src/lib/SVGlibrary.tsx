...
const HomeIcon = (props: SVGPropsType) => {
  return (
    <svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg" style={props.style ? props.style : undefined} >
      <path fillRule="evenodd" clipRule="evenodd" d="M11.5832 0.191085C11.8478 0.0697686 12.1522 0.0697687 12.4168 0.191085L22.5587 4.84099C23.5346 5.28845 23.2156 6.75 22.1419 6.75H20.517C20.9135 7.37091 21.1433 8.10858 21.1433 8.89991V17.8999C21.1433 20.1091 19.3524 21.8999 17.1433 21.8999H7.14329C4.93415 21.8999 3.14329 20.1091 3.14329 17.8999V8.89991C3.14329 8.10858 3.37309 7.37091 3.76959 6.75H1.85808C0.784431 6.75 0.465354 5.28845 1.44132 4.84099L11.5832 0.191085ZM10.1433 9.89991C9.59101 9.89991 9.14329 10.3476 9.14329 10.8999V14.8999C9.14329 15.4522 9.59101 15.8999 10.1433 15.8999H14.1433C14.6956 15.8999 15.1433 15.4522 15.1433 14.8999V10.8999C15.1433 10.3476 14.6956 9.89991 14.1433 9.89991H10.1433Z" fill={props.color ? props.color : '#AFAEB3'} />
    </svg>
  );
};

const Battery3 = (props: SVGPropsType) => {
  return (
...
const Battery2 = (props: SVGPropsType) => {
  return (
    <svg width="31" height="17" viewBox="0 0 31 17" fill="none" xmlns="http://www.w3.org/2000/svg" style={props.style ? props.style : undefined} >
      <path fillRule="evenodd" clipRule="evenodd"
        d="M3 0C1.34315 0 0 1.34315 0 3V14C0 15.6569 1.34315 17 3 17H26C27.6569 17 29 15.6569 29 14V12.9999C29.0043 13 29.0085 13 29.0128 13C30.1103 13 31 10.9853 31 8.5C31 6.01472 30.1103 4 29.0128 4C29.0085 4 29.0043 4.00003 29 4.00009V3C29 1.34315 27.6569 0 26 0H3Z"
...
const Battery1 = (props: SVGPropsType) => {
  return (
    <svg width="31" height="17" viewBox="0 0 31 17" fill="none" xmlns="http://www.w3.org/2000/svg" style={props.style ? props.style : undefined} >
      <path fillRule="evenodd" clipRule="evenodd"
        d="M3 0C1.34315 0 0 1.34315 0 3V14C0 15.6569 1.34315 17 3 17H26C27.6569 17 29 15.6569 29 14V12.9999C29.0043 13 29.0085 13 29.0128 13C30.1103 13 31 10.9853 31 8.5C31 6.01472 30.1103 4 29.0128 4C29.0085 4 29.0043 4.00003 29 4.00009V3C29 1.34315 27.6569 0 26 0H3Z"
...
const Battery_null = (props: SVGPropsType) => {
  return (
    <svg width="31" height="17" viewBox="0 0 31 17" fill="none" xmlns="http://www.w3.org/2000/svg" style={props.style ? props.style : undefined} >
      <path fillRule="evenodd" clipRule="evenodd"
        d="M3 0C1.34315 0 0 1.34315 0 3V14C0 15.6569 1.34315 17 3 17H26C27.6569 17 29 15.6569 29 14V12.9999C29.0043 13 29.0085 13 29.0128 13C30.1103 13 31 10.9853 31 8.5C31 6.01472 30.1103 4 29.0128 4C29.0085 4 29.0043 4.00003 29 4.00009V3C29 1.34315 27.6569 0 26 0H3Z"
...
export { ArrowBackIcon, CloseIcon, HamburgerMenuIcon, HomeIcon, Battery3, Battery2, Battery1, Battery_null };
